    ...
    render(){
        return(
            <div className="top-bottom-spacing">
                <button type="button" className="btn btn-danger" data-toggle="modal" data-target="#myModal">confirmation modal</button>
                
                <button type="button" className="btn btn-danger" data-toggle="modal" data-target="#spam-popup">spam</button>

                <div className="text-center">
                    <img src="../assets/img/no-result.png" className="no-result-img" alt='no_result' />
