                ...
                <div className="landing-banner-sec">
                    <img className="landing-banner-img" src="assets/img/banner_small.jpg" 
                        srcset="assets/img/banner_small.jpg 1000w, 
                                ...
                                assets/img/banner_large.jpg 1800w" alt="banner_image" />
                                ...
                                <div id="home" className="tab-pane active">
                                    <div className="row">
                                        <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 center-align">
                                            <h2 className="cancel-text">if you decide Netflix isn't for you – no problem. No commitment. Cancel online at any time.</h2>
                                            <Link to="auth/register.html" className="btn btn-danger join-btn">join free for a month</Link>
                                        </div>
                                ...
                                <div id="menu1" className="tab-pane fade">
                                    <div className="row center-align">
                                        <div className="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                                            <h3 className="devices-text">watch TV programmes and films at any time, anywhere – personalised for you.</h3>
                                        </div>
                                    ...
                                    <div className="row text-center">
                                        <div className="col-md-12 col-lg-4 col-xl-4">
                                            ...
                                            <p className="device-img-para">smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray players and more.</p>
                                        </div>
                                        <div className="col-md-12 col-lg-4 col-xl-4">
                                            <div className="devices-img">
                                                <img src="assets/img/tab.png" alt="Tab" />
                                            </div>
                                            <h4 className="device-img-txt">watch instantly or download for later</h4>
                                            <p className="device-img-para">Available on phone and tablet, wherever you go.</p>
                                        </div>
                                        <div className="col-md-12 col-lg-4 col-xl-4">
                                            <div className="devices-img">
