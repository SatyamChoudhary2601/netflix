                ...
                <div className="col-sm-10 col-md-9 col-lg-7 col-xl-6 auto-margin">
                  <div className="payment-option">
                    ...
                    <div className="payment-note">
                      <p className="mb-0">
                        <span className="bold">Note:</span> You are a Normal
                        User. If you are Paid User, you need not make any
                        payment to watch the video. If you want to become a paid
                        user, please choose a plan so as to become a paid user.
                      </p>
                    </div>
