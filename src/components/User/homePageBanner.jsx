          ...
          <div className="banner-text-centeralign">
            <div>
              ...
              <h4 className="banner_video_text">
                ...
                an underground civilization that needs a hero.An ordinary teen.
                An ancient relic pulled from the rubble. And an underground
                civilization that needs a hero.
              </h4>
