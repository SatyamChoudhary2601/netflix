...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    $(".home-slider.verticle-slider .slick-slide .sliderthumb").height(
      verticleVideoHeight
    );

    $(".home-slider.verticle-slider .slick-slide").css(
      "margin-top",
      verticleVideoHeightDiff / 2
    );
    ...
    if (windowWidth > 991) {
      ...
      $(".home-slider.verticle-slider .slick-slide .sliderthumb").mouseover(
        function() {
          $(this).css("height", verticleVideoHeight * verticleScaling);
        }
      );
      ...
      $(".home-slider.verticle-slider .slick-slide .sliderthumb").mouseout(
        function() {
          $(this).css("height", verticleVideoHeight * 1);
        }
      );
      ...
      $(".show-video-details.home-slider .slick-slide .sliderthumb").mouseover(
        function() {
          $(this).css("height", videoHeight * 1);
        }
      );
      ...
      <div>
        ...
        <div className="main p-40">
          <div className="main-slidersec">
            ...
            <Slider
              {...mylistsSlider}
              className="mylist-slider home-slider slider"
            >
          ...
          <div className="main-slidersec">
            ...
            <Slider
              {...mylistsSlider}
              className="mylist-slider verticle-slider home-slider slider"
            >
              <div className="sliderthumb">
                <img
                  className="sliderthumb-img hoverout-img placeholder"
